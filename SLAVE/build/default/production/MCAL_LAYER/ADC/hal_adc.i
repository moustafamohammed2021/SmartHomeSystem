...
# 11 "MCAL_LAYER/ADC/../GPIO/../mcal_std_types.h" 2
...
# 1 "MCAL_LAYER/ADC/../GPIO/hal_gpio_config.h" 1
...
static __attribute__((inline)) void adc_input_channel_port_select(adc_channel_select_t Channel);
static __attribute__((inline)) void adc_select_voltageRefernce(const adc_config_t *_adc);
static __attribute__((inline)) void adc_selectTheResultFormat(const adc_config_t *_adc);
...
Std_ReturnType ADC_IsConversionDone(const adc_config_t *_adc , uint8 *conversion_status){
    Std_ReturnType ret=(Std_ReturnType)0x01;
        if ((((void*)0)==_adc) || (conversion_status==((void*)0))){
            ret=(Std_ReturnType)0x00;
        }
        else {
...
static __attribute__((inline)) void adc_select_voltageRefernce(const adc_config_t *_adc){
    if (0x01U==_adc->volatge_reference){
        do{ADCON1bits.VCFG0=1; ADCON1bits.VCFG1=1; }while(0);
    }
    else if (0x00U==_adc->volatge_reference){
